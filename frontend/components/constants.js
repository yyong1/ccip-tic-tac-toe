...
export const abi = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "providedIndex", type: "uint256" },
  ...
  { inputs: [], name: "NoMessageReceived", type: "error" },
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: "address", name: "player_1", type: "address" },
          { internalType: "address", name: "player_2", type: "address" },
          { internalType: "address", name: "winner", type: "address" },
          { internalType: "address", name: "turn", type: "address" },
          { internalType: "uint8[9]", name: "player1Status", type: "uint8[9]" },
          { internalType: "uint8[9]", name: "player2Status", type: "uint8[9]" },
        ],
        indexed: false,
  ...
  {
    inputs: [
      { internalType: "uint8[9]", name: "playerStatus", type: "uint8[9]" },
    ],
    name: "checkWin",
    outputs: [{ internalType: "bool", name: "_return", type: "bool" }],
  ...
  {
    inputs: [{ internalType: "bytes32", name: "_sessionId", type: "bytes32" }],
    name: "getBoardStatus",
    outputs: [{ internalType: "uint8[9]", name: "board", type: "uint8[9]" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "player", type: "uint256" },
      { internalType: "bytes32", name: "sessionId", type: "bytes32" },
      {
        internalType: "uint64",
        name: "destinationChainSelector",
...
export const contractAddress = {
  // here new contract address which we depl
  fuji: "0x0081576a8F1ba51811ccE2d95B52C0457f9041E1",
  sepolia: "0x25Ec5F66e5DDF9e9909E7fcB1A4Ee77FDF01De37",
